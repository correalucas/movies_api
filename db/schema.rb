...
ActiveRecord::Schema.define(version: 2019_06_09_121251) do
  ...
  create_table "episodes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["catalogue_id"], name: "index_episodes_on_catalogue_id"
  end
  ...
  create_table "options", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["catalogue_id"], name: "index_options_on_catalogue_id"
  end
  ...
  add_foreign_key "episodes", "catalogues"
  add_foreign_key "libraries", "options"
  add_foreign_key "libraries", "users"
  add_foreign_key "options", "catalogues"
end
